...
Quickie: [Get started](https://github.com/lenosisnickerboa/csgosl/wiki). Download **2.14** : [Linux](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.14/csgosl-linux.zip) [Windows](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.14/csgosl-windows.zip) 
