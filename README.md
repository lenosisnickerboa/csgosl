...
Quickie: [Get started](https://github.com/lenosisnickerboa/csgosl/wiki). Download **1.8.2** : [Linux](https://github.com/lenosisnickerboa/csgosl/releases/download/v1.8.2/csgosl-linux.zip) [Windows](https://github.com/lenosisnickerboa/csgosl/releases/download/v1.8.2/csgosl-windows.zip) 
