...
Quickie: [Get started](https://github.com/lenosisnickerboa/csgosl/wiki). Download **1.7** : [Linux](https://github.com/lenosisnickerboa/csgosl/releases/download/v1.7/csgosl-linux.zip) [Windows](https://github.com/lenosisnickerboa/csgosl/releases/download/v1.7/csgosl-windows.zip) 
