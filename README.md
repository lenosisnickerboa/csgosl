...
Quickie: [Get started](https://github.com/lenosisnickerboa/csgosl/wiki). Download **2.7.3** : [Linux](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.7.3/csgosl-linux.zip) [Windows](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.7.3/csgosl-windows.zip) 
