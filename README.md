...
Quickie: [Get started](https://github.com/lenosisnickerboa/csgosl/wiki). Download **2.0** : [Linux](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.0/csgosl-linux.zip) [Windows](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.0/csgosl-windows.zip) 
