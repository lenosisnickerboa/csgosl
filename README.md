...
Quickie: [Get started](https://github.com/lenosisnickerboa/csgosl/wiki). Download **1.8.3** : [Linux](https://github.com/lenosisnickerboa/csgosl/releases/download/v1.8.3/csgosl-linux.zip) [Windows](https://github.com/lenosisnickerboa/csgosl/releases/download/v1.8.3/csgosl-windows.zip) 
...
So far, after 15000+ downloads I have received three (yes really, three!) donations adding up to a total of 20$. Not quitting my daytime job anytime soon...
