...
Quickie: [Get started](https://github.com/lenosisnickerboa/csgosl/wiki). Download **1.3.1** : [Linux](https://github.com/lenosisnickerboa/csgosl/releases/download/v1.3.1/csgosl-linux.zip) [Windows](https://github.com/lenosisnickerboa/csgosl/releases/download/v1.3.1/csgosl-windows.zip) 
