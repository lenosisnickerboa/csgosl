...
Quickie: [Get started](https://github.com/lenosisnickerboa/csgosl/wiki). Download **2.8.3** : [Linux](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.8.3/csgosl-linux.zip) [Windows](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.8.3/csgosl-windows.zip) 
