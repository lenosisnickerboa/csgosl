...
Quickie: [Get started](https://github.com/lenosisnickerboa/csgosl/wiki). Download **1.8** : [Linux](https://github.com/lenosisnickerboa/csgosl/releases/download/v1.8/csgosl-linux.zip) [Windows](https://github.com/lenosisnickerboa/csgosl/releases/download/v1.8/csgosl-windows.zip) 
