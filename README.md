...
Quickie: [Get started](https://github.com/lenosisnickerboa/csgosl/wiki). Download **2.6.7** : [Linux](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.6.7/csgosl-linux.zip) [Windows](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.6.7/csgosl-windows.zip) 
