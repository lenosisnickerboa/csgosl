...
Quickie: [Get started](https://github.com/lenosisnickerboa/csgosl/wiki). Download **2.15** : [Linux](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.15/csgosl-linux.zip) [Windows](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.15/csgosl-windows.zip) 
