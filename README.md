...
Quickie: [Get started](https://github.com/lenosisnickerboa/csgosl/wiki). Download **2.10** : [Linux](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.10/csgosl-linux.zip) [Windows](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.10/csgosl-windows.zip) 
