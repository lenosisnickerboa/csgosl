...
Quickie: [Get started](https://github.com/lenosisnickerboa/csgosl/wiki). Download **1.2.3** : [Linux](https://github.com/lenosisnickerboa/csgosl/releases/download/v1.2.3/csgosl-linux.zip) [Windows](https://github.com/lenosisnickerboa/csgosl/releases/download/v1.2.3/csgosl-windows.zip) 
