...
Quickie: [Get started](https://github.com/lenosisnickerboa/csgosl/wiki). Download **1.2.1** : [Linux](https://github.com/lenosisnickerboa/csgosl/releases/download/v1.2.1/csgosl-linux.zip) [Windows](https://github.com/lenosisnickerboa/csgosl/releases/download/v1.2.1/csgosl-windows.zip) 
