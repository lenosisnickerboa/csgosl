...
Quickie: [Get started](https://github.com/lenosisnickerboa/csgosl/wiki). Download **2.12** : [Linux](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.12/csgosl-linux.zip) [Windows](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.12/csgosl-windows.zip) 
