...
Quickie: [Get started](https://github.com/lenosisnickerboa/csgosl/wiki). Download **2.7.6** : [Linux](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.7.6/csgosl-linux.zip) [Windows](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.7.6/csgosl-windows.zip) 
