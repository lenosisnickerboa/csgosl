...
Quickie: [Get started](https://github.com/lenosisnickerboa/csgosl/wiki). Download **2.5** : [Linux](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.5/csgosl-linux.zip) [Windows](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.5/csgosl-windows.zip) 
