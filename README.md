...
Quickie: [Get started](https://github.com/lenosisnickerboa/csgosl/wiki). Download **2.6.2** : [Linux](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.6.2/csgosl-linux.zip) [Windows](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.6.2/csgosl-windows.zip) 
