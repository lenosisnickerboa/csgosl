...
Quickie: [Get started](https://github.com/lenosisnickerboa/csgosl/wiki). Download **2.7.1** : [Linux](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.7.1/csgosl-linux.zip) [Windows](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.7.1/csgosl-windows.zip) 
