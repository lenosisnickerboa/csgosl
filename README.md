...
Quickie: [Get started](https://github.com/lenosisnickerboa/csgosl/wiki). Download **2.13** : [Linux](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.13/csgosl-linux.zip) [Windows](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.13/csgosl-windows.zip) 
