...
Quickie: [Get started](https://github.com/lenosisnickerboa/csgosl/wiki). Download **1.8.1** : [Linux](https://github.com/lenosisnickerboa/csgosl/releases/download/v1.8.1/csgosl-linux.zip) [Windows](https://github.com/lenosisnickerboa/csgosl/releases/download/v1.8.1/csgosl-windows.zip) 
