...
Quickie: [Get started](https://github.com/lenosisnickerboa/csgosl/wiki). Download **2.9.4** : [Linux](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.9.4/csgosl-linux.zip) [Windows](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.4.3/csgosl-windows.zip) 
