...
Quickie: [Get started](https://github.com/lenosisnickerboa/csgosl/wiki). Download **1.1.1** : [Linux](https://github.com/lenosisnickerboa/csgosl/releases/download/v1.1.1/csgosl-linux.zip) [Windows](https://github.com/lenosisnickerboa/csgosl/releases/download/v1.1.1/csgosl-windows.zip) 
<bt>Download stats [here](http://www.somsubhra.com/github-release-stats/?username=lenosisnickerboa&repository=csgosl)
