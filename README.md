...
Quickie: [Get started](https://github.com/lenosisnickerboa/csgosl/wiki). Download **2.18** : [Linux](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.18/csgosl-linux.zip) [Windows](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.18/csgosl-windows.zip) 
