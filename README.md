...
Quickie: [Get started](https://github.com/lenosisnickerboa/csgosl/wiki). Download **2.9.6** : [Linux](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.9.6/csgosl-linux.zip) [Windows](https://github.com/lenosisnickerboa/csgosl/releases/download/v2.9.6/csgosl-windows.zip) 
<br>Download stats [here](https://somsubhra.github.io/github-release-stats/?username=lenosisnickerboa&repository=csgosl&page=1&per_page=5)
